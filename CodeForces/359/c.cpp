...
int main(){
    ...
    while(maxn>6){dign++;maxn/=7;arr1.push_back(maxn%7);}
    while(maxm>6){digm++;maxm/=7;arr2.push_back(maxm%7);}
    if(dign+digm>7){cout<<0<<endl;return 0;}
