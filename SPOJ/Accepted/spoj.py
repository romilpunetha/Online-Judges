...
if __name__ == "__main__":
    ...
    parser.add_option("-o", "--outputpath", default="./",
                      type=str, help="Destination directory to store solutions")
    parser.add_option("-p", "--proxy", default="", type=str,
                      help="Proxy , ex- http://username:password@proxy:port")
